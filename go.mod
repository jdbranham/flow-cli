...
require (
	...
	github.com/onflow/flow-cli/pkg/flowkit v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/onflow/flow-go v0.26.16 // indirect
...
replace github.com/onflow/cadence/languageserver => ../cadence/languageserver